...
TRACE_EVENT(plsc_open,
	...
	TP_printk("{\"action\":\"%s\", \"start\":%llu, \"delta\":%llu, \"uid\":%lu, \"task\":\"%s\", \"path\":\"%s\", \"pid\":%lu, \"upid\":%lu, \"retval\":%i, \"session\":%i, \"size\":%lli, \"type\": %i, \"flags\":%i, \"mode\":%i}", __get_str(action), __entry->start, __entry->delta, __entry->uid, __entry->comm, __entry->pathname, __entry->pid, __entry->upid, __entry->retval, __entry->session, __entry->size, __entry->type, __entry->flags, __entry->mode)
);
...
TRACE_EVENT(plsc_rw,
	...
	TP_printk("{\"action\":\"%s\", \"start\":%llu, \"delta\":%llu, \"pid\":%lu, \"upid\":%lu, \"retval\":%i, \"session\":%i, \"fd\":%i, \"bytes\":%i, \"offset\":%llu}", __get_str(action), __entry->start, __entry->delta, __entry->pid, __entry->upid, __entry->retval, __entry->session, __entry->fd, __entry->bytes, __entry->offset)
);
...
TRACE_EVENT(plsc_mmap,
	...
	TP_printk("{\"action\":\"%s\", \"start\":%llu, \"delta\":%llu, \"pid\":%lu, \"upid\":%lu, \"retval\":%lu, \"session\":%i, \"fd\":%i, \"addr\":%lu, \"len\":%lu, \"prot\":%lu, \"flags\":%lu, \"pgoff\":%lu}", __get_str(action), __entry->start, __entry->delta, __entry->pid, __entry->upid, __entry->retval, __entry->session, __entry->fd, __entry->addr, __entry->len, __entry->prot, __entry->flags, __entry->pgoff)
);
...
TRACE_EVENT(plsc_lseek,
	...
	TP_printk("{\"action\":\"%s\", \"start\":%llu, \"delta\":%llu, \"pid\":%lu, \"upid\":%lu, \"retval\":%i, \"session\":%i, \"fd\":%i, \"offset\":%llu, \"origin\":%u}", __get_str(action), __entry->start, __entry->delta, __entry->pid, __entry->upid, __entry->retval, __entry->session, __entry->fd, __entry->offset, __entry->origin)
);
...
TRACE_EVENT(plsc_sync,
	...
	TP_printk("{\"action\":\"%s\", \"start\":%llu, \"delta\":%llu, \"pid\":%lu, \"upid\":%lu, \"retval\":%i, \"session\":%i, \"fd\":%i}", __get_str(action), __entry->start, __entry->delta, __entry->pid, __entry->upid, __entry->retval, __entry->session, __entry->fd)
);
...
TRACE_EVENT(plsc_dup,
	...
	TP_printk("{\"action\":\"%s\", \"pid\":%lu, \"upid\":%lu, \"retval\":%i, \"session\":%i, \"oldfd\":%i, \"newfd\":%i, \"flags\":%i}", __get_str(action), __entry->pid, __entry->upid, __entry->retval, __entry->session, __entry->oldfd, __entry->newfd, __entry->flags)
);
